...
public class BookGenresController {
    ...
    @HystrixCommand(commandKey="getFallKey", fallbackMethod="fallbackBookGenreDtoBookId")
    ...
    private Content fallbackBookGenreDtoBookId(BookGenreDto bookGenreDto, long bookId) {
        return fallback();
    }
