...
@DataJpaTest
@Import({BookDaoImpl.class, BookCommentDaoImpl.class})
class BookDaoImplTest {
    ...
    void addComment() {
        ...
        for (BookComment bookComment1 : book1.get(0).getComments()) {
    ...
    void updateComment() {
        ...
        bookDao.update(book);
        List<Book> book1 = bookDao.getById(id);
        for (BookComment bookComment2 : book1.get(0).getComments()) {
        ...
        List<Book> book2 = bookDao.getById(id);
        BookComment bookCommentResult = null;
        for (BookComment bookComment2 : book2.get(0).getComments()) {
