...
public class GenreController implements MenuItems {
    ...
    public List<Menu> getMenu() {
        return List.of(new Menu(2, "Жанры", new Link(HttpMethod.GET, "/genre/list"), true));
    }
    ...
    public Content edit(@RequestParam("id") long id) {
        ...
        save.setLink(new Link(HttpMethod.PUT, "/genre/save?id=" + genre.getId()));
    ...
    public Content add() {
        ...
        add.setLink(new Link(HttpMethod.POST, "/genre/create"));
        add.setTitle("Добавить");
        content.setManagement(List.of(add));
        name.setType(FieldType.INPUT);
        name.setLabel("Наименование");
    ...
    private Table getTableAll() {
        ...
        for (Genre genre : service.getAll()) {
            Row row = new Row();
            row.setLink(new Link(HttpMethod.GET, "/genre/view?id=" + genre.getId()));
    ...
    private Content getContentView(long id) {
        ...
        edit.setLink(new Link(HttpMethod.GET, "/genre/edit?id=" + genre.getId()));
        delete.setPosition(2);
        delete.setTitle("Удалить");
        delete.setLink(new Link(HttpMethod.DELETE, "/genre/delete?id=" + genre.getId()));
