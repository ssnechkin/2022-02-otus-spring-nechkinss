package ru.otus.homework.service.repository.book;
...
class BookServiceImplTest {
    ...
    void addAuthor() {
        ...
        assertTrue(bookT.getAuthorIdList().contains(author.getId()));
        ...
        assertFalse(bookT2.getAuthorIdList().contains(author2.getId()));
    ...
    void deleteAuthor() {
        ...
        Book bookT2 = bookService.getById(book.getId());
        assertFalse(bookT2.getAuthorIdList().contains(author.getId()));
    ...
    void addGenre() {
        ...
        Book bookT = bookService.getById(book.getId());
        assertTrue(bookT.getGenreIdList().contains(genre.getId()));
        ...
        Book bookT2 = bookService.getById(book.getId());
        assertFalse(bookT2.getGenreIdList().contains(genre2.getId()));
    ...
    void deleteGenre() {
        ...
        Book bookT2 = bookService.getById(book.getId());
        assertFalse(bookT2.getGenreIdList().contains(genre.getId()));
    ...
    void addComment() {
        ...
        Book book1 = bookService.getById(bookComment.getBookId());
        assertEquals(book1.getName(), book.getName());
        Book bookT = bookService.getById(book.getId());
        BookComment bookComment1 = bookService.getBookCommentById(bookT.getCommentIdList().get(0));
    ...
    void editComment() {
        ...
        Book bookT2 = bookService.getById(book.getId());
        BookComment bookComment2 = bookService.getBookCommentById(bookT2.getCommentIdList().get(0));
    ...
    void deleteComment() {
        ...
        assertEquals(0, bookT.getCommentIdList().size());
        bookService.delete(book);
    }
    ...
    void deleteCommentAfterDeleteBook() {
        ...
        String bId = UUID.randomUUID().toString();
        Book book = bookService.add("name" + bId);
        String commentId = bookService.addComment(book, "comment" + cId).getId();
        Book bookT = bookService.getById(book.getId());
        BookComment bookComment1 = bookService.getBookCommentById(bookT.getCommentIdList().get(0));
        assertEquals("comment" + cId, bookComment1.getComment());
        bookService.delete(book);
